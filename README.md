...
\*\*[Shopping Cart App] is a website for all shopping fans where you can add an item to the shopping cart and get all the total amount of items you purchased.
...
```sh
  ...
  git clone https://github.com/Kevin-Mena/shopping-cart.git
...
Feel free to check the [issues page](https://github.com/Kevin-Mena/shopping-cart/issues).
